...
class TgRedisConsumer(BaseConsumer):
...
class RedisRabbitConsumer(BaseConsumer):
    def __init__(self, redis: ChunksStorage, rabbit: Rabbit) -> None:
        self._redis = redis
        self._rabbit = rabbit
